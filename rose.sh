...
clone()
{
     ...
     then
          ...
          wget https://github.com/ZyCromerZ/Clang/releases/download/14.0.6-20231003-release/Clang-14.0.6-20231003.tar.gz -O aosp-clang.tar.gz
     ...
     git clone --depth=1 https://github.com/Gartenn/Anykernelku
...
exports()
{
       ...
       KBUILD_BUILD_USER="Garten"
       KBUILD_BUILD_HOST="GearCi"
